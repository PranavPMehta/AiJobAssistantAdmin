    ...
    <>
      ...
      <div className="bg-surface-card border border-slate-800 rounded-xl shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="min-w-[1100px] w-full divide-y divide-slate-800">
            <thead className="bg-slate-900/50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs text-slate-500 uppercase">Work Email</th>
                <th className="px-4 py-3 text-left text-xs text-slate-500 uppercase">Phone</th>
                <th className="px-4 py-3 text-left text-xs text-slate-500 uppercase">Current Role</th>
                <th className="px-4 py-3 text-left text-xs text-slate-500 uppercase">Experience</th>
                <th className="px-4 py-3 text-left text-xs text-slate-500 uppercase">Python Level</th>
                <th className="px-4 py-3 text-left text-xs text-slate-500 uppercase">Program</th>
            ...
            <tbody className="divide-y divide-slate-800">
              {currentEnquiries.map((enquiry, index) => (
                <tr key={enquiry.enquiry_id} className="hover:bg-slate-800/30">
                  ...
                  <td className="px-4 py-4 text-sm text-slate-300">{enquiry.work_email}</td>
                  <td className="px-4 py-4 text-sm text-slate-300">{enquiry.phone_number}</td>
                  <td className="px-4 py-4 text-sm text-slate-300">{enquiry.current_role}</td>
                  <td className="px-4 py-4 text-sm text-slate-300">{enquiry.experience}</td>
                  <td className="px-4 py-4 text-sm text-slate-300">{enquiry.python_level}</td>
                  <td className="px-4 py-4 text-sm text-slate-300">{enquiry.program_name}</td>
